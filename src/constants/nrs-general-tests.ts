export type GeneralPerformedTestsNrChild = {
  selected: boolean
  text: string
}

export type GeneralPerformedTestsNrItem = {
  parent: string
  parentSelected: boolean
  children: GeneralPerformedTestsNrChild[]
}

export const examsNrs: GeneralPerformedTestsNrItem[] = [
  {
    parent:
