export type InjectorGaugeNrChild = {
  selected: boolean
  text: string
}

export type InjectorGaugeNrItem = {
  parent: string
  parentSelected: boolean
  children: InjectorGaugeNrChild[]
}
...
export const nrsForInjectorGauge: InjectorGaugeNrItem[] = [
  ...
  },
  {
    ...
    parentSelected: false,
    children: [
      { selected: false, text: 'a) materiais;' },
      { selected: false, text: 'b) procedimentos de execução;' },
      { selected: false, text: 'c) procedimentos de controle de qualidade; e' },
      { selected: false, text: 'd) qualificação e certificação de pessoal.' },
    ],
  },
]
