export type DischargeSystemNrChild = {
  selected: boolean
  text: string
}

export type DischargeSystemNrItem = {
  parent: string
  parentSelected: boolean
  children: DischargeSystemNrChild[]
}

export const nrsForDischargeSystem: DischargeSystemNrItem[] = [
  {
    parent:
