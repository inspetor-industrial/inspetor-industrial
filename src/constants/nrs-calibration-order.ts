export type CalibrationOrderNrChild = {
  selected: boolean
  text: string
}

export type CalibrationOrderNrItem = {
  parent: string
  parentSelected: boolean
  children: CalibrationOrderNrChild[]
}

export const nrsForCalibrationOrder: CalibrationOrderNrItem[] = [
  {
    parent:
