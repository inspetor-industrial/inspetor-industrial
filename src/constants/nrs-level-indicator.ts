export type LevelIndicatorNrChild = {
  selected: boolean
  text: string
}

export type LevelIndicatorNrItem = {
  parent: string
  parentSelected: boolean
  children: LevelIndicatorNrChild[]
}

export const nrsForLevelIndicator: LevelIndicatorNrItem[] = [
  {
    parent:
  ...
  {
    parent:
      '13.3.1 As seguintes situações constituem condição de grave e iminente risco: d) ausência ou indisponibilidade operacional de dispositivo de controle do nível de água na caldeira;',
    parentSelected: false,
    children: [],
  },
  {
